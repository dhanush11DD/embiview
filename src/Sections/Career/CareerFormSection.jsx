      ...
      <Container className="">
        <div className="flex flex-col col-span-1 lg:flex-row gap-16">
          ...
          <div className="flex-1 lg:flex-2">
            ...
            <div className="grid grid-cols-12 mt-10 lg:grid-cols-12 gap-x-4 gap-y-8 text-light-text">
              ...
              <div className="md:col-span-12 col-span-12 md:ml-auto ">
                <button className="btn btn-hover mt-10 md:mb-6 btn-outline flex gap-3 lg:mx-0   group">
